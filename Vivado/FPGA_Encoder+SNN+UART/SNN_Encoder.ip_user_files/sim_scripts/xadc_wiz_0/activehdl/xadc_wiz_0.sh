...
#
# Script generated by Vivado on Mon Apr 20 21:29:56 -0700 2026
...
map_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="C:/Github/SENIOR-PROJECT/Vivado/FPGA_Encoder+SNN+UART/SNN_Encoder.cache/compile_simlib/activehdl"
  fi
  if [[ ($lib_map_path != "") ]]; then
