...
N -610 310 -610 340 {
lab=VCM}
C {code.sym} -20 340 0 0 {name=TT_MODELS1 only_toplevel=true
...
C {/home/ee431/workspace/6SAR_CDAC/CDAC_4bit_VCM_simplified.sym} -600 970 0 0 {name=x9}
C {lab_pin.sym} -750 1000 2 1 {name=p44 sig_type=std_logic lab=b0}
C {lab_pin.sym} -750 980 2 1 {name=p45 sig_type=std_logic lab=b1}
C {lab_pin.sym} -750 960 2 1 {name=p46 sig_type=std_logic lab=b2}
C {lab_pin.sym} -750 940 2 1 {name=p47 sig_type=std_logic lab=b3}
C {lab_pin.sym} -750 900 0 0 {name=p48 sig_type=std_logic lab=VIN}
C {vsource.sym} -420 500 0 0 {name=V8 value="PULSE(0 1.8 50n       10n 10n 312.4u 625u)" savecurrent=false}
C {gnd.sym} -420 530 0 0 {name=l21 lab=GND}
C {vsource.sym} -380 440 0 0 {name=V9 value="PULSE(0 1.8 312.55u   10n 10n 312.4u 625u)" savecurrent=false}
C {gnd.sym} -380 470 0 0 {name=l22 lab=GND}
C {lab_pin.sym} -420 450 0 0 {name=p49 sig_type=std_logic lab=CLK5}
C {lab_pin.sym} -380 390 2 0 {name=p50 sig_type=std_logic lab=CLK5_N}
C {lab_pin.sym} -750 1040 0 0 {name=p51 sig_type=std_logic lab=CLK5}
C {lab_pin.sym} -750 1020 2 1 {name=p52 sig_type=std_logic lab=CLK5_N}
C {vsource.sym} -610 370 0 0 {name=V10 value=2.5 savecurrent=false}
C {gnd.sym} -610 400 0 0 {name=l23 lab=GND}
C {lab_pin.sym} -610 310 2 0 {name=p53 sig_type=std_logic lab=VCM}
C {lab_pin.sym} -750 920 2 1 {name=p54 sig_type=std_logic lab=VCM}
C {lab_pin.sym} -590 870 0 0 {name=p55 sig_type=std_logic lab=VDD5v}
