...
C {opin.sym} 180 30 0 0 {name=p15 lab=outp}
C {opin.sym} -180 30 0 1 {name=p10 lab=outn}
C {lab_pin.sym} -370 340 0 1 {name=p9 sig_type=std_logic lab=VDD}
C {lab_pin.sym} -390 80 0 1 {name=p16 sig_type=std_logic lab=VDD}
C {lab_pin.sym} -290 -60 0 1 {name=p17 sig_type=std_logic lab=VDD}
C {lab_pin.sym} -200 -50 0 0 {name=p18 sig_type=std_logic lab=VDD}
C {lab_pin.sym} 190 -50 0 1 {name=p19 sig_type=std_logic lab=VDD}
C {lab_pin.sym} 290 -60 0 0 {name=p20 sig_type=std_logic lab=VDD}
C {lab_pin.sym} 390 80 0 0 {name=p21 sig_type=std_logic lab=VDD}
C {lab_pin.sym} 0 -200 0 0 {name=p22 sig_type=std_logic lab=VDD}
C {devices/code.sym} 440 320 0 0 {name=TT_MODELS
only_toplevel=true
