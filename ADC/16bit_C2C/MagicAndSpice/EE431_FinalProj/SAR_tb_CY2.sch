...
N -80 440 -40 440 {
lab=CLK5_N}
C {code.sym} 90 270 0 0 {name=TT_MODELS1 only_toplevel=true
format="tcleval( @value )"
value=".lib \\\\$::SKYWATER_MODELS\\\\/sky130.lib.spice tt"}
C {code_shown.sym} 150 110 0 0 {name=spice1 only_toplevel=false value="
.tran 10000n 10m
.options method=gear reltol=1e-3 cshunt=1f rshunt=1G
.control
run
.endc"}
...
C {lab_pin.sym} -910 870 1 1 {name=p39 sig_type=std_logic lab=b0}
C {lab_pin.sym} -890 710 1 1 {name=p40 sig_type=std_logic lab=b1}
C {lab_pin.sym} -900 550 1 1 {name=p41 sig_type=std_logic lab=b2}
C {lab_pin.sym} -900 380 3 0 {name=p42 sig_type=std_logic lab=b3}
C {lab_pin.sym} -770 -20 0 0 {name=p43 sig_type=std_logic lab=COMP_1v8}
C {/home/ee431/workspace/6SAR_CDAC/CDAC_4bit_VCM_simplified.sym} -390 1120 0 0 {name=x9}
C {vsource.sym} -420 500 0 0 {name=V8 value="PULSE(0 5 50n       10n 10n 312.4u 625u)" savecurrent=false}
C {gnd.sym} -420 530 0 0 {name=l21 lab=GND}
C {lab_pin.sym} -420 400 0 0 {name=p49 sig_type=std_logic lab=CLK5}
C {lab_pin.sym} -30 440 2 0 {name=p50 sig_type=std_logic lab=CLK5_N}
C {lab_pin.sym} -540 1190 0 0 {name=p51 sig_type=std_logic lab=CLK5}
C {lab_pin.sym} -540 1170 2 1 {name=p52 sig_type=std_logic lab=CLK5_N}
C {vsource.sym} -720 1260 0 0 {name=V10 value=2.5 savecurrent=false}
C {gnd.sym} -720 1290 0 0 {name=l23 lab=GND}
C {lab_pin.sym} -720 1200 2 0 {name=p53 sig_type=std_logic lab=VCM}
C {lab_pin.sym} -540 1070 2 1 {name=p54 sig_type=std_logic lab=VCM}
C {gnd.sym} -540 1110 1 0 {name=l24 lab=GND}
C {gnd.sym} -600 1130 1 0 {name=l25 lab=GND}
C {gnd.sym} -640 1150 1 0 {name=l26 lab=GND}
C {gnd.sym} -830 1280 0 0 {name=l28 lab=GND}
C {lab_pin.sym} -830 1190 2 0 {name=p58 sig_type=std_logic lab=VddCDAC}
C {vsource.sym} -830 1250 0 0 {name=V12 value=5 savecurrent=false}
C {lab_pin.sym} -380 1020 2 1 {name=p59 sig_type=std_logic lab=VddCDAC}
C {lab_pin.sym} -540 1090 2 1 {name=p56 sig_type=std_logic lab=VddCDAC}
C {gnd.sym} -540 1050 2 0 {name=l27 lab=GND}
C {vsource.sym} -80 490 0 0 {name=V9 value="PULSE(5 0 50n       10n 10n 312.4u 625u)" savecurrent=false}
C {gnd.sym} -80 520 0 0 {name=l22 lab=GND}
